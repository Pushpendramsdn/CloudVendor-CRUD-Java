...
class CloudVendorServiceImplTest {
    ...
    @Test
    void testGetByCloudVendorName() {
        mock(CloudVendor.class);
        mock(CloudVendorRepository.class);
        when(cloudVendorRepository.findByVendorName("Amazon")).thenReturn(
                new ArrayList<CloudVendor>(Collections.singleton(cloudVendor))
        );
        assertThat(cloudVendorService.getByCloudVendorName("Amazon").get(0).getVendorName())
                .isEqualTo(cloudVendor.getVendorName());
        assertThat(cloudVendorService.getByCloudVendorName("Amazon").get(0).getVendorId())
    ...
    void testGetAllCloudVendor() {
        ...
        assertThat(cloudVendorService.getAllCloudVendor().get(0).getVendorName())
                .isEqualTo(cloudVendor.getVendorName());
        assertThat(cloudVendorService.getAllCloudVendor().get(0).getVendorId())
                .isEqualTo(cloudVendor.getVendorId());
    }
}